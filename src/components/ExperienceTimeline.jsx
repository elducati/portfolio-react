    ...
    <div className="relative py-5 my-5 p-8 md:p-16 ">
      {experiences.map((exp, index) => (
        ...
        >
          ...
          <div className="bg-gray-800 bg-opacity-50 p-4 rounded shadow-md ml-8 w-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 backdrop-blur hover:scale-105">
